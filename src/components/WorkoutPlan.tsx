    ...
    weekly: [
      {
        ...
        exercises: [
          ...
          { name: 'Torção russa', sets: '3x20', tip: 'Pode segurar peso' },
          { name: 'Ponte de glúteo', sets: '3x15', tip: 'Aperta o glúteo no topo' },
        ],
        calories: 220,
      },
      {
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: 'Burpees (salto + flexão)', sets: '3x10', tip: 'Descanso 60s entre séries' },
          { name: 'Escaladores', sets: '3x30s', tip: 'Core ativado' },
          { name: 'Agachamento com salto', sets: '3x12', tip: 'Aterrissa com joelhos suaves' },
        ],
        calories: 280,
      },
      {
